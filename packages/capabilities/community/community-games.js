...
import { observeInteraction, updateProfile } from '../../ainoria-intelligence/core/digital-twin.js';
import { addNode, NODE_TYPES } from '../../ainoria-intelligence/knowledge/knowledge-graph.js';
import { clock } from '../../ainoria-intelligence/core/cognitive-clock.js';
...
async function advanceQuiz(jid, game) {
  ...
  if (game.currentIndex >= game.questions.length) {
    ...
    await executor.execute({
      ...
      payload: {
        jid,
        text: `🏆 *Quiz terminé !*\n\nRésultats :\n${summary}\n\n📊 Tapez ".rank" pour voir le classement général.`,
      },
