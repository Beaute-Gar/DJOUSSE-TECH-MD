...
import { EVENTS, bus } from '../../ainoria-intelligence/core/event-bus.js';
...
import { audit } from '../../ainoria-intelligence/governance/audit-engine.js';
import { policy, POLICY_EFFECTS } from '../../ainoria-intelligence/governance/policy-engine.js';
import { observeInteraction } from '../../ainoria-intelligence/core/digital-twin.js';
import { addNode, NODE_TYPES } from '../../ainoria-intelligence/knowledge/knowledge-graph.js';
...
export async function handleCreatePoll(ctx, args, sock) {
  ...
  if (parts.length < 3) {
    await executor.execute({
      ...
      payload: { jid: ctx.jid, text: 'Utilisation : envoie "Crée un sondage Question | Option1 | Option2 | ... | durée(min)"' },
