...
const apkDownloader = async (m, sock) => {
  ...
  if (cmd === "app") {
    if (!text) {
      return sock.sendMessage(m.from, { text: "âŒ *Please provide an app name to search.*" }, { quoted: m });
    }
...
â”ƒ ðŸ“¦ *Name:* ${app.name}
â”ƒ ðŸ‹ *Size:* ${appSize} MB
â”ƒ ðŸ· *Package:* ${app.package}
â”ƒ ðŸ“… *Updated:* ${app.updated}
â•°â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
ðŸ”— *Powered By INCONNNU XD V2*`;
      ...
      return sock.sendMessage(m.from, { text: "âŒ *An error occurred while fetching the APK. Please try again.*" }, { quoted: m });
    }
  }
}
