...
const ping = async (m, sock) => {
  ...
  if (cmd === "joke") {
    try {
      ...
      await m.React('ðŸ˜‚'); // React with a laughing emoji
      ...
      sock.sendMessage(
        m.from,
        {
          ...
          contextInfo: {
            ...
            forwardedNewsletterMessageInfo: {
              newsletterJid: '120363397722863547@newsletter',
              newsletterName: "DJOUSSE-TECH-MD xá´á´… Ê™á´á´›",
              serverMessageId: -1,
            },
            forwardingScore: 999, // Score to indicate it has been forwarded
            externalAdReply: {
              title: "DJOUSSE-TECH-MD",
              body: "Êœá´‡Ê€á´‡'Ê€á´‡ á´€ á´Šá´á´‹á´‡ á´›á´ Êœá´‡ÊŸá´˜ Êá´á´œ ÊŸá´€á´œÉ¢Êœ",
              thumbnailUrl: 'https://files.catbox.moe/e1k73u.jpg', // Add thumbnail URL if required
              sourceUrl: 'https://whatsapp.com/channel/0029Vb6T8td5K3zQZbsKEU1R', // Add source URL if necessary
              mediaType: 1,
              renderLargerThumbnail: false,
  ...
  if (cmd === "ringtone") {
    ...
    try {
      ...
      await m.React('ðŸ”Š'); // React with a speaker emoji
