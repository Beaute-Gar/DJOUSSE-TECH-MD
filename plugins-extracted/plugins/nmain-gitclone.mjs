...
const gitCloneDownloader = async (m, sock) => {
  ...
  if (cmd === "gitclone") {
    ...
    if (!args[0]) return sock.sendMessage(m.chat, { text: `Where is the link?\nExample :\n${prefix}${cmd} https://github.com/INCONNU-BOY/DJOUSSE-TECH-MD` }, { quoted: m });
    ...
    try {
      ...
      sock.sendMessage(m.chat, { text: "âŒ An error occurred while processing your request. Please try again later." }, { quoted: m });
    }
  }
};
